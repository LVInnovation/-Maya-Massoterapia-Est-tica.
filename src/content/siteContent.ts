...
export const defaultSiteConfig: SiteConfig = {
  ...
  home: {
    heroBadge: '✨ Sistema de Agendamento Premium',
    heroTitleStart: 'Descubra a',
    heroTitleHighlight: 'beleza',
    heroTitleEnd: 'premium que existe em você',
    heroSubtitle:
    ...
    professionalsBadge: 'Nossa Equipe Premium',
    ...
    ctaTitle: 'Pronto para uma transformação premium?',
    ctaSubtitle:
      'Agende seu horário agora e descubra uma nova versão refinada de si mesma. Nossa equipe premium está pronta para transformar você.',
  },
  footer: {
